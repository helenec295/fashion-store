        ...
        "loading"
         ...
         <div className="left">
            ...
            <div className="mainImg">
              <img
                // src={selectedImg}
                src={data && data.attributes && data.attributes[selectedImg]?.data?.attributes?.url ? process.env.REACT_APP_UPLOAD_URL + data.attributes[selectedImg].data.attributes.url : ''}
